            ...
            <div class="accordion-body">
              <table class="table table-hover">
                ...
                @foreach($orders as $order)
                  <tr class="table-light">
                    <td width="50%">{{$order['productname']}}</td>
                ...
                @endforeach
                  ...
                  <tr class="table-light">
                    <td colspan="4">
                      <div class="row">
                        <label for="inputAddress" class="col-sm-2 col-form-label">收件人：</label>
                        <div class="col-sm-10">
                          <input type="text" name="address" class="form-control" value="{{$data[$groupid][0]['username']}}" disabled>
                        </div>
                      </div>
                    </td>
                  </tr>
